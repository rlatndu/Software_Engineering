...
CREATE TABLE `activity_logs` (
  ...
  `action_type` enum('PAGE_MOVE','ISSUE_CREATE','ISSUE_EDIT','COMMENT') COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `issue_files` (
  ...
  PRIMARY KEY (`id`),
  KEY `issue_id` (`issue_id`),
  CONSTRAINT `issue_files_ibfk_1` FOREIGN KEY (`issue_id`) REFERENCES `issues` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `issues` (
  ...
  CONSTRAINT `issues_ibfk_2` FOREIGN KEY (`assignee_id`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `issues_ibfk_3` FOREIGN KEY (`parent_issue_id`) REFERENCES `issues` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `notifications` (
  `id` int NOT NULL AUTO_INCREMENT,
  `user_id` int NOT NULL,
  `type` enum('ASSIGN','DEADLINE','COMMENT') COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `project_members` (
  `project_id` int NOT NULL,
  `user_id` int NOT NULL,
  `role` enum('PM','MEMBER') COLLATE utf8mb4_general_ci DEFAULT 'MEMBER',
...
CREATE TABLE `projects` (
  ...
  `key_prefix` varchar(10) COLLATE utf8mb4_general_ci NOT NULL,
  `access_type` enum('PUBLIC','RESTRICTED') COLLATE utf8mb4_general_ci DEFAULT 'RESTRICTED',
  `manager_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `site_id` (`site_id`),
  KEY `manager_id` (`manager_id`),
  CONSTRAINT `projects_ibfk_1` FOREIGN KEY (`site_id`) REFERENCES `sites` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `sites` (
  ...
  CONSTRAINT `sites_ibfk_1` FOREIGN KEY (`owner_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  `name` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `role` enum('ADMIN','PM','MEMBER') COLLATE utf8mb4_general_ci DEFAULT 'MEMBER',
...
-- Dump completed on 2025-05-12 20:24:41
